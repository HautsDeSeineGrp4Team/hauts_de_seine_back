...
from api.auth import dep_current_user
...
def read_current_user(current_user: dep_current_user):
    """Retourne les informations de l'utilisateur connecté"""
    return current_user


@router.put("/me")
def update_user(current_user: dep_current_user, user_update: UserUpdate, db: Session = Depends(get_db)):
    """
...
@router.delete("/me")
def delete_user(current_user: dep_current_user, db: Session = Depends(get_db)):
    """
